	...
	m_iconName()
{
	...
	else
	{
		...
		connect( m_renameLineEdit, &QLineEdit::editingFinished, this, &TrackLabelButton::renameFinished );
	}
	
	setIconSize( QSize( 24, 24 ) );
	connect( m_trackView->getTrack(), &Track::dataChanged, this, QOverload<>::of(&TrackLabelButton::update) );
	connect( m_trackView->getTrack(), &Track::nameChanged, this, &TrackLabelButton::nameChanged );
}
